              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <input
                    ...
                    checked={footerConfig.show_privacy_policy}
                    onChange={(e) => setFooterConfig({ ...footerConfig, show_privacy_policy: e.target.checked })}
                    className="w-4 h-4 text-[#b71c1c] border-gray-300 rounded focus:ring-[#b71c1c]"
                  />
                  <label htmlFor="show_privacy_policy" className="text-sm font-medium text-gray-700">
                    显示隐私政策链接
                  </label>
                </div>
                <input
                  type="text"
                  value={footerConfig.privacy_policy_url}
                  onChange={(e) => setFooterConfig({ ...footerConfig, privacy_policy_url: e.target.value })}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#b71c1c] focus:border-transparent"
                  placeholder="#"
                />
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <input
                    type="checkbox"
                    id="show_terms"
                    checked={footerConfig.show_terms}
                    onChange={(e) => setFooterConfig({ ...footerConfig, show_terms: e.target.checked })}
                    className="w-4 h-4 text-[#b71c1c] border-gray-300 rounded focus:ring-[#b71c1c]"
                  />
                  <label htmlFor="show_terms" className="text-sm font-medium text-gray-700">
                    显示使用条款链接
                  </label>
                </div>
                <input
                  type="text"
                  value={footerConfig.terms_url}
                  onChange={(e) => setFooterConfig({ ...footerConfig, terms_url: e.target.value })}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#b71c1c] focus:border-transparent"
                  placeholder="#"
                />
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <input
                    type="checkbox"
                    id="show_sitemap"
                    checked={footerConfig.show_sitemap}
                    onChange={(e) => setFooterConfig({ ...footerConfig, show_sitemap: e.target.checked })}
                    className="w-4 h-4 text-[#b71c1c] border-gray-300 rounded focus:ring-[#b71c1c]"
                  />
                  <label htmlFor="show_sitemap" className="text-sm font-medium text-gray-700">
                    显示网站地图链接
                  </label>
                </div>
                <input
                  type="text"
                  value={footerConfig.sitemap_url}
                  onChange={(e) => setFooterConfig({ ...footerConfig, sitemap_url: e.target.value })}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#b71c1c] focus:border-transparent"
                  placeholder="#"
                />
              </div>
